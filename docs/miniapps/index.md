...
- Эталонные и экспериментальные миниапы — см. публичный репо [korfixdev/miniapps-examples](https://github.com/korfixdev) (когда появится) или спроси у команды Korfix.
